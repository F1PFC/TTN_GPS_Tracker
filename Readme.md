...
\$GNGGA,102207.00,\$GNRMC,102208.00,V,,,,,,,121018,,,N\*61
...
fix. It is important to check that the GPS does get a fix and that the
...
It is important to test that the LoRa device is connected correctly
